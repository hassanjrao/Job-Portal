            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->segment(2) == 'locations' ? ' active' : '' }}"
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->segment(2) == 'categories' ? ' active' : '' }}"
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->segment(2) == 'jobs' ? ' active' : '' }}"

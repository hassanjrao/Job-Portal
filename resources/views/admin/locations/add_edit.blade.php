...
@php
    $addEdit = isset($location) ? 'Edit' : 'Add';
    $addUpdate = isset($location) ? 'Update' : 'Add';
@endphp
@section('page-title', $addEdit . ' Location')
@section('content')
    ...
    <div class="content content-boxed">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default d-flex">
                <h3 class="block-title">{{ $addEdit }} Location</h3>
                    ...
                    <div class="col-lg-12 ">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <?php
                                $value = old('name_en', $location ? $location->name_en : null);
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <?php
                                $value = old('name_ar', $location ? $location->name_ar : null);
